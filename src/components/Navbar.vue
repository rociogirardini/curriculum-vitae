<template>
  ...
  <v-card v-else>
    <v-tabs bg-color="pink-darken-2" align-tabs="center" stacked>
      ...
      <v-spacer></v-spacer>
      <v-img class="lang-icon" src="src/assets/icons/arg.png" @click="toggleLocale('es')"/>
      <br/>
      <v-img class="lang-icon" src="src/assets/icons/usa.png" style="margin-right:1rem ;" @click="toggleLocale('en')"/>
    </v-tabs>
  </v-card>
</template>
